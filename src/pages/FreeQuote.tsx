          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8 text-left">
              <div className="p-6 bg-gray-50 dark:bg-black rounded-2xl border border-gray-200 dark:border-white/10">
                ...
                <p className="text-3xl font-bold text-neon-purple">Rp {result.priceIdr.toLocaleString('id-ID')}</p>
              </div>
              <div className="p-6 bg-gray-50 dark:bg-black rounded-2xl border border-gray-200 dark:border-white/10">
                <p className="text-gray-500 mb-1">{t('quote.priceUsd')}</p>
                <p className="text-3xl font-bold text-green-500">${result.priceUsd.toLocaleString()}</p>
              </div>
              <div className="p-6 bg-gray-50 dark:bg-black rounded-2xl border border-gray-200 dark:border-white/10">
